...
const {getMovies, pushMovie, findMovies, listMovies, getMoviescate, postComment, deleteMovies, userData, loginIn, getUser , pushUsers, changePass , notify , loginInAd, Searchmovie,  editMovie, pushSeries, deletemovie, deleteComment, deleteoneComment , upcomingPush, latest, findMovie , check, Search} = require('../Controller/controller')
